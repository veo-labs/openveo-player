 ...
 *  - [Boolean] **opl-chapters** true to display chapters (default to true)
 *  - [Boolean] **opl-indexes** true to display indexes (default to true)
 *  - [Boolean] **opl-tags** true to display tags (default to true)
